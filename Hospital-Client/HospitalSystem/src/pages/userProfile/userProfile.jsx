      ...
      case "communication":
        return (
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition duration-300"
            >
              Send Message
            </button>
          </form>
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white mt-10 rounded-3xl shadow-lg">
      <div className="mb-8 p-6 text-center bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 rounded-2xl">
        ...
        <p className="text-gray-600">
          Helping little stars shine bright and healthy!
        </p>
      </div>
